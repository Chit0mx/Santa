...
public class Animacion  extends JFrame implements Runnable{
    ...
    public void Duende(Graphics g, int x, int y){
        ...
        try {
            imgDuende = ImageIO.read(new File("/Users/chit0mx/IdeaProjects/Santa/src/main/java/images/duende.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void Santa(Graphics g, int x, int y){
        ...
        try {
            imgSanta = ImageIO.read(new File("/Users/chit0mx/IdeaProjects/Santa/src/main/java/images/santa.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void Reno(Graphics g, int x, int y){
        ...
        try {
            imgSanta = ImageIO.read(new File("/Users/chit0mx/IdeaProjects/Santa/src/main/java/images/reno.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
